	...
	funcao inicio()
	{
		...
		faca {
			...
			se (numero_digitado > 0) {
				...
				// sintaxe do "para":
				// para ( inicializacao ; condiçao de repetição ; incremento )
				para(inteiro numero_do_loop = numero_digitado ; numero_do_loop <= numero_digitado*numero_digitado ; numero_do_loop ++) {
